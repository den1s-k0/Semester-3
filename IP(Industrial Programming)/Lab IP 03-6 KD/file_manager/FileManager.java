...
public class FileManager {
    ...
    private static CafeMenuPosition parseTextLine(String line) {
        ...
        switch (type) {
            case "DRINK": return Drink.fromFileString(line);
            case "MAIN_COURSE": return MainCourse.fromFileString(line);
            case "DESSERT": return Dessert.fromFileString(line);
            ...
            if (inQuotes) {
                ...
                if (c == '{') {
                    ...
                    if (braceCount == 0) {
                        ...
                        // Пропускаем запятую после объекта

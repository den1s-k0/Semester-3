...
- [Лабораторная работа 4: Паттерны.](#лабораторная-работа-4-паттерны)
- [Лабораторная работа 5: Графический интерфейс (AWT или Swing или SWT или JAVA fX) и потоки Thread.](#лабораторная-работа-5-графический-интерфейс-awt-или-swing-или-swt-или-java-fx-и-потоки-thread)
...
- [Задача 1.0.7: Строго возрастающая без разрывов подпоследовательность.](#задача-107-строго-возрастающая-без-разрывов-подпоследовательность)
- [Задача 1.58: Свертка строки.](#задача-158-свертка-строки)  

Задачи на поисковые деревья:
...
- [Задача 2.23.](#задача-223) 

Задачи на специализированные структуры данных:
- [Задача 3.0.2: Бинарная куча?](#задача-302-бинарная-куча)
- [Задача 3.0.4: Кодирование Хаффмана (сложная версия).](#задача-304-кодирование-хаффмана-сложная-версия)
- [Задача 3.0.5: Строительство дорог.](#задача-305-строительство-дорог)
- [Задача 3.0.7: Разрушение дорог (сложная версия).](#задача-307-разрушение-дорог-сложная-версия)
- [Задача 3.0.8: Задача о сумме.](#задача-308-задача-о-сумме)
- [Задача 3.0.10: Хеш-таблица.](#задача-3010-хеш-таблица)
- [Задача 3.10: Лабиринт с конкретным входом-выходом.](#задача-310-лабиринт-с-конкретным-входом-выходом)

Задачи на графовые алгоритмы:
- [Задача 4.0.1: Построить матрицу смежности.](#задача-401-построить-матрицу-смежности)
- [Задача 4.0.2: Канонический вид (по списку дуг).](#задача-402-канонический-вид-по-списку-дуг)
- [Задача 4.0.3: Построить список смежности.](#задача-403-построить-список-смежности)
- [Задача 4.0.4: Канонический вид (по матрице смежности).](#задача-404-канонический-вид-по-матрице-смежности)
- [Задача 4.0.5: Поиск в ширину.](#задача-405-поиск-в-ширину)
- [Задача 4.0.6: Поиск в глубину.](#задача-406-поиск-в-глубину)
- [Задача 4.0.7: Алгоритм Дейкстры.](#задача-407-алгоритм-дейкстры)
- [Задача 4.58: С.Т.А.Л.К.Е.Р.: туда и обратно.](#задача-458-сталкер-туда-и-обратно)
...
## Лабораторная работа 5: Графический интерфейс (AWT или Swing или SWT или JAVA fX) и потоки Thread.

### Общее задание:
1. Создать графическое приложение для предыдущей лабораторной.
2. Создать поток(и) Thread для параллельной записи\чтения данных в файлы
JSON\ XML.
3. Использовать элементы для добавления новой информации и вывода
информации:
    - Использовать кнопки
    ...
    - И т.д.
4. Запись кода и кода тестов на GitHub
...
2. Разработать процесс-клиент Client, который выполняет следующие действия:
    ...
    - 2.4. При чтении записи процесс-клиент выполняет следующие действия:
        + 2.4.1. Запрашивает ключ записи;
        + 2.4.2. Посылает запрос на сервер;
        + 2.4.3. Выводит полученную с сервера запись на консоль;
        + 2.4.4. По команде с консоли завершает доступ к записи.
...
# АиСД: Задачи на рекуррентные соотношения.
...
Найти наибольшее $k$, для которого существуют две последовательности индексов $0 \le i_1 < i_2 < \ldots < i_k < n$ и $0 \le j_1 < j_2 < \ldots < j_k < n$, что $A_{i_1} = B_{j_1}$, $A_{i_2} = B_{j_2}$, …, $A_{i_k} = B_{j_k}$. Также нужно найти и сами последовательности индексов.
...
Во второй строке выведите индексы $i_{1}\, i_{2}\, \ldots\, i_k$.  
...
## Задача 1.0.7: Строго возрастающая без разрывов подпоследовательность.
- Имя входного файла: input.txt
- Имя выходного файла: output.txt
...
# АиСД: Задачи на поисковые деревья.
...
### Формат входных данных:
Входной файл содержит в первой строке число K (2 ≤ K ≤ 10^9), а в последующих строках — последовательность чисел — ключи вершин в порядке добавления в дерево.

### Формат выходных данных:
Выходной файл должен содержать последовательность ключей вершин, полученную прямым левым обходом итогового дерева.

# АиСД: Задачи на специализированные структуры данных.

## Задача 3.0.2: Бинарная куча?
- Имя входного файла: input.txt
- Имя выходного файла: output.txt
- Ограничение по времени: 1 с
- Ограничение по памяти: 256 МБ
...
## Задача 3.0.4: Кодирование Хаффмана (сложная версия).
...
Заметим, что символы алфавита представлены листьями этого дерева. Для каждого листа (символа) длина его кода Хаффмана равна длине пути от корня дерева до него.
...
## Задача 3.0.5: Строительство дорог.
- Имя входного файла: input.txt
- Имя выходного файла: output.txt
- Ограничение по времени: 1 с
- Ограничение по памяти: 256 МБ
...
## Задача 3.0.7: Разрушение дорог (сложная версия).
- Имя входного файла: input.txt
- Имя выходного файла: output.txt
...
## Задача 3.10: Лабиринт с конкретным входом-выходом.
- Имя входного файла: in.txt
- Имя выходного файла: out.txt
- Ограничение по времени: 1 с
- Ограничение по памяти: нет
...
# АиСД: Задачи на графовые алгоритмы.

## Задача 4.0.1: Построить матрицу смежности.
- Имя входного файла: input.txt
- Имя выходного файла: output.txt
- Ограничение по времени: 1 с
- Ограничение по памяти: 64 МБ
...
## Задача 4.0.2: Канонический вид (по списку дуг).
- Имя входного файла: input.txt
- Имя выходного файла: output.txt
- Ограничение по времени: 1 с
- Ограничение по памяти: 256 МБ
...
## Задача 4.0.3: Построить список смежности.
- Имя входного файла: input.txt
- Имя выходного файла: output.txt
- Ограничение по времени: 1 с
...
## Задача 4.0.4: Канонический вид (по матрице смежности).
- Имя входного файла: input.txt
- Имя выходного файла: output.txt
- Ограничение по времени: 1 с
- Ограничение по памяти: 256 МБ
...
## Задача 4.0.7: Алгоритм Дейкстры.
- Имя входного файла: input.txt
- Имя выходного файла: output.txt
- Ограничение по времени: 1 с
- Ограничение по памяти: 64 МБ
...
## Задача 4.58: С.Т.А.Л.К.Е.Р.: туда и обратно.
...
### Формат входных данных:
В первой строке входного файла записаны два числа M и N — количество строк и столбцов в плане лабиринта (1 ≤ M, N ≤ 500).
...
Если решение задачи по какой-либо причине невозможно, выведите число −1.Что значит сделать один неверный шаг…
